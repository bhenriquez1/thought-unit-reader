...
export default function WhiteboardPanel({
  ...
  // Auto-trigger (e.g., from detection)
  useEffect(() => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex gap-2 items-center flex-wrap">
        <Button onClick={handleExplainConcept} disabled={loading || !concept?.trim()}>

...
const TIER_CONFIG: Record<HighlightTier, KindConfig> = {
  master: {
    ...
    ringClass:  "ring-1 ring-yellow-300/60 shadow-[0_0_6px_rgba(253,224,71,0.40)]",
  ...
  decision: {
    ...
    ringClass:  "ring-2 ring-sky-300/60",
  ...
  danger: {
    ...
    ringClass:  "ring-1 ring-red-300/60 shadow-[0_0_6px_rgba(252,165,165,0.40)]",

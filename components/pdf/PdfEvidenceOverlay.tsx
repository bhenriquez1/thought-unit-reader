...
// Surgical annotation values — anchors are almost invisible at rest so the page
// reads like a textbook; the focused state and the active-word box (in SmartPDFViewer)
// carry the emphasis. bgNormal ≤ 0.05, bgFocused ≤ 0.18, rings always ring-1.
const TIER_CONFIG: Record<HighlightTier, KindConfig> = {
  master: {
    label:      "MASTER",
    bgNormal:   "rgba(253,224,71,0.05)",
    bgFocused:  "rgba(253,224,71,0.16)",
    restGlow:   "0 0 1px rgba(253,224,71,0.08)",
    ringClass:  "ring-1 ring-yellow-300/40",
  ...
  step: {
    label:      "STEP",
    bgNormal:   "rgba(134,239,172,0.05)",
    bgFocused:  "rgba(134,239,172,0.16)",
    restGlow:   "0 0 1px rgba(134,239,172,0.07)",
    ringClass:  "ring-1 ring-emerald-300/40",
  ...
  decision: {
    label:      "DECISION",
    bgNormal:   "rgba(147,197,253,0.05)",
    bgFocused:  "rgba(147,197,253,0.16)",
    restGlow:   "0 0 1px rgba(147,197,253,0.07)",
    ringClass:  "ring-1 ring-sky-300/40",
  ...
  danger: {
    label:      "DANGER",
    bgNormal:   "rgba(252,165,165,0.06)",
    bgFocused:  "rgba(252,165,165,0.18)",
    restGlow:   "0 0 1px rgba(252,165,165,0.08)",
    ringClass:  "ring-1 ring-red-300/40",
  ...
  pearl: {
    label:      "PEARL",
    bgNormal:   "rgba(103,232,249,0.04)",
    bgFocused:  "rgba(103,232,249,0.14)",
    restGlow:   "0 0 1px rgba(103,232,249,0.06)",
    ringClass:  "ring-1 ring-cyan-300/40",

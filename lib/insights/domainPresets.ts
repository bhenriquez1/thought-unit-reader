...
export const DOMAIN_PRESETS: DomainPreset[] = [
  ...
  },
  {
    ...
    kindGroups: [
      ...
      { id: "pearls",          label: "Pearl",          kinds: ["clinical", "memoryAnchor"] },
      { id: "checkpoint",      label: "Checkpoint",     kinds: ["dat_fact", "keyDetail"] },
    ],
  },
  {
  ...
  },
  {
    ...
    kindGroups: [
      { id: "master",     label: "Master This",         kinds: ["thesis", "definition"] },
      { id: "concept",    label: "Concept",             kinds: ["application", "comparison", "keyDetail", "keyAnatomy"] },
      { id: "pathways",   label: "Mechanism / Pathway", kinds: ["mechanism", "formula"] },
      { id: "key_facts",  label: "Key Fact",            kinds: ["dat_fact", "memoryAnchor"] },
      { id: "traps",      label: "Exam Trap",           kinds: ["trap"] },
      { id: "checkpoint", label: "Checkpoint",          kinds: ["clinical"] },
    ],
  },
  {
    id: "math",
  ...
  },
  {
    ...
    kindLabels: {
      ...
      mechanism:    "Framework / Model",
      formula:      "Framework / Model",
      application:  "Real-World Example",
      comparison:   "Real-World Example",
      keyDetail:    "Key Insight",
      keyAnatomy:   "Key Insight",
      trap:         "Risk / Pitfall",
      clinical:     "Case Study",
      memoryAnchor: "Key Insight",
      dat_fact:     "Key Insight",
    },
    kindGroups: [
      { id: "core",      label: "Core Concept",       kinds: ["thesis", "definition"] },
      { id: "framework", label: "Framework / Model",  kinds: ["mechanism", "formula"] },
      { id: "examples",  label: "Real-World Example", kinds: ["application", "comparison", "clinical"] },
      { id: "pitfalls",  label: "Risk / Pitfall",     kinds: ["trap"] },
      { id: "insights",  label: "Key Insight",        kinds: ["dat_fact", "keyDetail", "keyAnatomy", "memoryAnchor", "reference", "filler", "unknown"] },
    ],
  },
  {
    id: "humanities",
    ...
    kindLabels: {
      ...
      clinical:     "Analysis",
      memoryAnchor: "Key Moment",
      dat_fact:     "Key Fact",
      formula:      "Key Fact",
    },
    kindGroups: [
      { id: "argument", label: "Central Argument", kinds: ["thesis", "definition"] },
      { id: "evidence", label: "Evidence",         kinds: ["mechanism", "dat_fact"] },
      { id: "context",  label: "Context",          kinds: ["keyDetail", "keyAnatomy", "formula"] },
      { id: "analysis", label: "Analysis",         kinds: ["application", "clinical", "memoryAnchor"] },
      { id: "counter",  label: "Counterargument",  kinds: ["comparison", "trap", "reference", "filler", "unknown"] },
    ],
  },
  {
    id: "notes",

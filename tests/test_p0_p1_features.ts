...
describe('studySessionStore', () => {
  ...
  test('getWeakItemsCount returns 0 when no weak items', () => {
    // Simulated test - in real scenario would use actual store
    const weakItems: any[] = [];
...
console.log('=== P0/P1 Feature Tests ===');
console.log('Testing: studySessionStore, syllabusStore, annotationStore, quizStore');
console.log('Features: Quick Study, Resume Session, Topic Study, Silent NoteLab capture, Quiz flashcards');
